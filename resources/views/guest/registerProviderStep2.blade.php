...
@section('content')
                        ...
                        <div>
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Vendedor "
                                    ...
                                    required="required" type="text" name="vendedor" id="vendedor" maxlength="60" 
                                    value="{{ old('vendedor') ?? (session('step2Data') ? session('step2Data')['vendedor'] : '') }}"
                                    >
                                @error('vendedor')
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Vendedor Reemplazo "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    type="text" name="vendedor_reemplazo" id="vendedor_reemplazo" maxlength="60" 
                                    value="{{ old('vendedor_reemplazo') ?? (session('step2Data') ? session('step2Data')['vendedor_reemplazo'] : '') }}"
                                    >
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Teléfono Vendedor "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    required="required" type="text" name="telefono_vendedor" id="telefono_vendedor" maxlength="30" 
                                    value="{{ old('telefono_vendedor') ?? (session('step2Data') ? session('step2Data')['telefono_vendedor'] : '') }}"
                                    >
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Extensión "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    type="text" name="extension" id="extension" maxlength="10" 
                                    value="{{ old('extension') ?? (session('step2Data') ? session('step2Data')['extension'] : '') }}"
                                    >
                                @error('extension')
                                    <p class="text-xs text-red-500 text-right my-3">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Celular "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    required="required" type="text" name="celular" id="celular" maxlength="10" 
                                    value="{{ old('celular') ?? (session('step2Data') ? session('step2Data')['celular'] : '') }}"
                                    >
                                @error('celular')
                                    <p class="text-xs text-red-500 text-right my-3">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Email Ventas "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    required="required" type="email" name="email_ventas" id="email_ventas" maxlength="30" 
                                    value="{{ old('email_ventas') ?? (session('step2Data') ? session('step2Data')['email_ventas'] : '') }}"
                                    >
                                @error('email_ventas')
                                    <p class="text-xs text-red-500 text-right my-3">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:space-y-2">
                                ...
                                <input placeholder="Horario de Atención "
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    required="required" type="text" name="horario_atencion" id="horario_atencion" maxlength="30"
                                    value="{{ old('horario_atencion') ?? (session('step2Data') ? session('step2Data')['horario_atencion'] : '') }}"
                                     >
                            ...
                            <div class="md:space-y-2">
                                ...
                                <select
                                    ...
                                    <option value="si" {{ (old('servicio_entrega') ?? (session('step2Data') ? session('step2Data')['servicio_entrega'] : '')) == 'si' ? 'selected' : '' }}>Si</option>
                                    <option value="no" {{ (old('servicio_entrega') ?? (session('step2Data') ? session('step2Data')['servicio_entrega'] : '')) == 'no' ? 'selected' : '' }}>No</option>
                                </select>
    ...
    <script>
        function backStep1() {
            window.location.href = "{{ route('RegisterProviderController.backStep1') }}";
        }
    </script>
@endsection
